    ...
    <div>
      ...
      >
        ...
        <button
          ...
          className="w-full bg-white hover:bg-gray-100 text-gray-700 font-bold py-2 px-4 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-400 mt-4 border border-gray-300"
        >
          Sign in with Google
        </button>
